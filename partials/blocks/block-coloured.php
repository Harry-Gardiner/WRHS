<section class="coloured-block">
    ...
    <div class="coloured-block__content container pt-4 pb-4">
        <?php if (have_rows('wr_coloured_block')) : ?>
            <?php while (have_rows('wr_coloured_block')) :
                ...
                if ($wr_coloured_block_secondary_image) : ?>
                    <figure class="coloured-block__image coloured-block__image--secondary">
                ...
                <div class="coloured-block__content">
