 ...
 * 
 * CPT used to house WRHS documents and magazines
 */
function wrhs_register_custom_post()
{
    /*
    ...
    $args = array(
        ...
        'menu_icon'           => 'dashicons-book-alt',  // The URL for the icon used for this post type
...
add_action('init', 'wrhs_register_custom_post', 0);
